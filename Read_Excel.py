...
[data-testid="stTabs"] [role="tablist"] {
    gap: 2px; /* مسافة بسيطة بين التابات */
}

/* تصميم التاب الفردي */
[data-testid="stTab"] {
    height: 45px;
    background-color: #e0e0e0; /* لون التاب غير النشط */
    color: #555;
    border-radius: 4px 4px 0 0 !important; /* حواف علوية فقط */
    border: none !important;
    padding: 0 30px !important;
    font-weight: 600;
    margin-bottom: 0px !important; /* التأكد من الالتصاق */
}
...
/* إزالة الانيميشن والخط الملون تحت التاب النشط */
...
.stDataFrame {
    margin-top: -1px !important; /* سحب الجدول للأعلى ليلتصق بالتابات تماماً */
}

/* جعل حواف الجدول حادة وتنسيق الحدود */
[data-testid="stTable"] , [data-testid="stDataFrame"] {
    border: 1px solid #ddd !important;
    border-radius: 0px !important; /* حواف حادة */
}

/* تنسيق رأس الجدول ليكون متناسقاً */
thead th {
